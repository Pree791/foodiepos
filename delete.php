...
<div class="banner">
    ...
    <div class=entries-ver>   
        <center>
        <h2>Enter the Product ID you want to delete:</h2>
        <form name="deleteform" action="delete1.php" method="post">
        <table>
        <tr>
            <td><h2><b style='margin-left:50px'>Product ID</b></h2></td>
            <td><b style='margin-left:20px'><input type="text" name="aproductid" class="text-radius1"></b></td>
            <td><input type="submit" value="Go" class="sbtn btn-transition" /></td>
